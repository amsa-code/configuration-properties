...
final class ConfigurationUtil {
	...
	static Double getDoubleMandatory(Configuration configuration,
			String key) {
	...
	private static Object checkNotNull(String key, Object object) {
		if (object == null)
			throw new RuntimeException("configuration item '" + key
					+ "' must not be null");
		return object;
	}
	...
	static Integer getIntegerMandatory(Configuration configuration,
			String key) {
	...
	static boolean getBoolean(Configuration configuration, String key) {
		...
		if (s == null)
			throw new RuntimeException("configuration item '" + key
					+ "' must be set to true or false but is null");
	...
	static Date getDateMandatory(Configuration configuration, String key) {
		...
		try {
			...
			throw new RuntimeException(
					"date could not be parsed from configuration item " + key
							+ "=" + s);
		}
	}
    ...
    static boolean getBooleanMandatory(String key, String value) {
        if (value == null)
            throw new NullPointerException("configuration item '" + key + "' must be set to true or false but was null");
